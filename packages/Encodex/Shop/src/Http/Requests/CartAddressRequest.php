...
namespace Encodex\Shop\Http\Requests;
...
class CartAddressRequest extends FormRequest
{
    ...
    private function mergeAddressRules(string $addressType)
    {
        $this->mergeWithRules([
            ...
            "{$addressType}.state"        => core()->isStateRequired() ? ['nullable'] : ['nullable'],
            "{$addressType}.postcode"     => core()->isPostCodeRequired() ? ['nullable', 'numeric'] : ['nullable', 'numeric'],
